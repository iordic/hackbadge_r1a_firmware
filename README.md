...
- WiFi attacks are adapted from [pr3y/Bruce](https://github.com/pr3y/Bruce).
---

**Licenses**  
Please check the licenses of the above repositories (e.g., MIT, GPL, etc.) and ensure your usage complies with them. If required, include the original license texts or attribution notices in your project.
